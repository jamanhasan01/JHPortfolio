          ...
          <div className="flex-1 flex flex-col items-start gap-6 text-center lg:text-left">
            ...
            <BoxReveal boxColor={"#f97316"} duration={0.5}>
              <p className="text-lg max-w-lg">
                Junior MERN stack developer with 1+ years experience, started
                in 2019 as a front-end developer (HTML, CSS, JS). Currently
            ...
            {/* Download Button */}
            <a
              href="https://drive.google.com/file/d/1JM62WELdF6kwR-DhRYhrhe5QK6Fs4ncd/view?usp=sharing"
              target="_blank"
